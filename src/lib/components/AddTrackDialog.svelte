<script lang="ts">
	...
	export let title, content, description, overlay, close;
</script>
...
>
	...
	<fieldset class="space-y-2">
		<label class="w-[90px] text-right text-stone-800" for="link"
			>YouTube URL, Spotify Track or Playlist Link</label
		>
		<input
