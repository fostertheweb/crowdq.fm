...
<div
	class="bg-gradient-to-br from-jake-50/60 to-sienna-50 p-8 dark:from-stone-950 dark:to-sienna-950">
...
<section id="features" class="border-t-4 border-sienna-100 p-8 dark:border-sienna-900">
	<div
...
<section
	class="border-t-4 border-sienna-100 bg-gradient-to-br from-sienna-50 to-jake-50/40 p-8 dark:border-sienna-900 dark:from-sienna-950 dark:to-stone-950">
	<div class="mx-auto flex w-full max-w-5xl flex-col justify-center gap-16 py-16 lg:flex-row">
		<div class="space-y-4 text-left lg:w-1/2">
			<h3 class="font-readex-pro text-3xl font-semibold text-sienna-900 dark:text-sienna-50">
				Listen Together
			</h3>
